...
const styles = StyleSheet.create({
  ...
  refreshButtonText: { color: COLORS.teal, fontSize: 13, fontWeight: '800' },
  ...
  currencyText: { color: COLORS.white, fontSize: 12, fontWeight: '900' },
  balanceLabel: { color: '#BFDAD7', fontSize: 13, marginTop: 38 },
  balanceValue: {
    color: COLORS.white,
    fontSize: 37,
    lineHeight: 46,
  ...
  walletMetaLabel: { color: '#BFDAD7', fontSize: 11, lineHeight: 16 },
  walletMetaValue: {
    color: COLORS.white,
    fontSize: 15,
    fontWeight: '900',
  ...
  walletStatusText: { color: COLORS.white, fontSize: 11, fontWeight: '800' },
  walletUpdated: { color: '#9EC5C1', fontSize: 11, marginTop: 15 },
  card: {
    padding: 19,
    borderWidth: 1,
    borderColor: COLORS.border,
  ...
  quickAmountText: { color: COLORS.muted, fontSize: 12, fontWeight: '800' },
  ...
  bankOptionName: { color: COLORS.ink, fontSize: 14, fontWeight: '800' },
  bankOptionNumber: { color: COLORS.muted, fontSize: 12, lineHeight: 17, marginTop: 3 },
  miniDefaultBadge: {
    paddingHorizontal: 7,
    paddingVertical: 4,
    borderRadius: 9,
  ...
  miniDefaultText: { color: COLORS.teal, fontSize: 10, fontWeight: '900' },
  noBankBox: {
    padding: 14,
    borderRadius: 13,
    backgroundColor: COLORS.surface,
  ...
  noBankText: { color: COLORS.muted, fontSize: 13, lineHeight: 19 },
  primaryButton: {
    minHeight: 52,
    marginTop: 4,
    borderRadius: 26,
  ...
  helperText: { color: COLORS.muted, fontSize: 12, lineHeight: 18, marginTop: 11 },
  message: {
  ...
  outlineButtonText: { color: COLORS.teal, fontSize: 13, fontWeight: '900' },
  ...
  transactionTitle: { color: COLORS.ink, fontSize: 14, fontWeight: '900' },
  transactionMeta: { color: COLORS.muted, fontSize: 11, lineHeight: 16, marginTop: 4 },
  transactionDescription: { color: COLORS.muted, fontSize: 11, lineHeight: 16, marginTop: 3 },
  transactionAmountBlock: { alignItems: 'flex-end', maxWidth: '42%' },
  transactionAmount: { color: COLORS.ink, fontSize: 13, fontWeight: '900' },
  ...
  transactionStatusText: { color: '#936000', fontSize: 10, fontWeight: '900' },
  ...
  compactEmptyTitle: { color: COLORS.ink, fontSize: 15, fontWeight: '900', marginTop: 9 },
  compactEmptyText: {
    color: COLORS.muted,
    fontSize: 12,
    lineHeight: 17,
  ...
  bankLogoText: { color: COLORS.tealDark, fontSize: 10, fontWeight: '900' },
  linkedBankCopy: { flex: 1, minWidth: 0, paddingLeft: 11 },
  bankNameRow: { flexDirection: 'row', alignItems: 'center', gap: 7 },
  linkedBankName: { flexShrink: 1, color: COLORS.ink, fontSize: 14, fontWeight: '900' },
  defaultBadge: {
    paddingHorizontal: 7,
    paddingVertical: 4,
    borderRadius: 9,
  ...
  defaultBadgeText: { color: COLORS.teal, fontSize: 10, fontWeight: '900' },
  linkedBankNumber: { color: COLORS.ink, fontSize: 12, fontWeight: '700', marginTop: 5 },
  linkedBankHolder: { color: COLORS.muted, fontSize: 11, lineHeight: 16, marginTop: 3 },
  ...
  outlineSubmitText: { color: COLORS.teal, fontSize: 14, fontWeight: '900' },
  securityNote: {
    padding: 12,
    marginTop: 13,
    borderRadius: 13,
  ...
  securityNoteText: { flex: 1, color: COLORS.tealDark, fontSize: 12, lineHeight: 18 },
  initialStateCard: {
    minHeight: 330,
    padding: 28,
    borderWidth: 1,
  ...
  initialStateTitle: { color: COLORS.ink, fontSize: 20, fontWeight: '900', marginTop: 17 },
  initialStateText: {
    color: COLORS.muted,
    fontSize: 13,
    lineHeight: 20,
  ...
  primaryRetryText: { color: COLORS.white, fontSize: 14, fontWeight: '900' },
});
